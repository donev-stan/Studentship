      ...
      <Container className="my-4">
        ...
        >
          ...
          <Row className="text-center">
            <Col>
              <Button type="submit" className="mb-3 shadowItem">
                Login
              </Button>
            </Col>
          </Row>
          ...
          <Form.Group className="my-4 text-center">
            ...
            >
              <Row>
                <Col>
                  <Image src={imgLeftRegister} style={imgStyles} />
                </Col>
                ...
                <Col>
                  <Image src={imgRightRegister} rounded style={imgStyles} />
                </Col>
              </Row>
            </Container>
          </Form.Group>
