    ...
    <>
      ...
      <Container>
        <Row style={{ position: "relative"}}>
          ...
          <h3 style={{ position: "absolute", marginTop: "50px", marginLeft: "65px", color: "white", textShadow: "1px 1px black"}}>Your future is created by what <br/> you do  today not tomorrow!</h3>
          <hr />
        </Row>
